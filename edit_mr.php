...
<!-- Content Wrapper. Contains page content -->
  ...
  <section class="invoice">
    <!-- title row -->
      <div class="row">
        <div class="col-xs-12">
          <h2 class="page-header">
            <i class="fa fa-globe"></i> Edit Form Material Request
      ...
      <form role="form" method="post" onSubmit="if(!confirm('Apakah anda yakin menyimpan data ini?')){return false;}"  action="update_mr.php?no_pc=<?php echo $row['no_pc'] ?>" enctype="multipart/form-data">
     <div class="row">
        <div class="col-md-12">
