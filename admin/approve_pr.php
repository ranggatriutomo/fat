<?php include_once('header.php');?>
  ...
  <section class="content-header">
      <h1>
        Form
        <small>Approval Status Purchase</small>
      </h1>
      <ol class="breadcrumb">
            ...
            <form role="form" method="post" onSubmit="if(!confirm('Apakah anda yakin menyimpan data ini?')){return false;}" action="update_approve.php?no_pc=<?= $no_pc ?>" enctype="multipart/form-data">
              <div class="box-body">
                <div class="form-group col-xs-6">
                  <label for="exampleInputEmail1">Nomor Purchase</label>
                ...
                <div class="form-group col-xs-6">
                  ...
                  <input type="text" name="no_pc" class="form-control" value="<?php echo $row['keterangan']; ?>"  readonly="readonly">
                </div>
                <div class="form-group col-xs-6">
                  <label for="exampleInputEmail1">No.Proyek</label>
                  <input type="text" name="no_pc" class="form-control" value="<?php echo $row['no_proyek']; ?>"  readonly="readonly">
                </div>
                <div class="form-group col-xs-6">
                  <label for="exampleInputEmail1">Cost Center</label>
                  <input type="text" name="no_pc" class="form-control" value="<?php echo $row['perihal']; ?>"  readonly="readonly">
                </div>
